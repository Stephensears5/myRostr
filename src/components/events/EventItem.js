    ...
    <div>
      ...
      <Card className="event-item">
        ...
        <div className="event-item__description">
          ...
          {isCreator && <div className="event-deleteitem"><button className={"delete-button"} onClick={deleteHandler}>Delete</button></div>} 
          {!isCreator && !error && !isAttending && <div className="event-notsignupcheck"><BsIcons.BsCheckCircle className="notsignup-check" onClick={signUpHandler}>Sign-up</BsIcons.BsCheckCircle></div>} 
          {!isCreator && error && isAttending && <p>Already Signed Up.</p>}
          {isAttending && !error && !isCreator && <div className="event-signupCheck"><BsIcons.BsCheckCircleFill onClick={signUpHandler} className="signup-check"/></div>}
        </div>
      </Card>
    </li>
    }
